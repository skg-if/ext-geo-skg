...
For example, the current (i.e., last) version of the JSON-LD context is available at [https://w3id.org/skg-if/extension/geo-skg/context/skg-if.json](https://w3id.org/skg-if/extension/geo-skg/context/skg-if.json).
